    ...
    >
      ...
      >
        <div className="flex items-center gap-2 mb-12">
          <span className="font-sans text-[12px] text-[#181818] tracking-[0.2em] uppercase font-bold">VIEW METRIC</span>
      ...
      >
        <div className="flex items-center gap-2 mb-12">
          <span className="font-sans text-[15px] text-[#94fa50] tracking-[0.2em] uppercase font-bold">SECURE AUDIT UPLOAD</span>
        ...
        {success ? (
          ...
          <div className="my-auto py-16 text-center flex flex-col items-center gap-6" id="form-success-boundary">
            ...
            <div className="font-mono text-[10px] text-[#94fa50] bg-[#94fa50]/10 px-4 py-2 border border-[#94fa50]/20 mt-4 uppercase tracking-widest">
              TX REFERENCE: {Math.random().toString(36).substring(2, 9).toUpperCase()}_OK
            </div>
            <button
          ...
          <div className="my-auto" id="audit-form-container">
            ...
            <form onSubmit={handleSubmit} className="flex flex-col gap-6" id="audit-form">
              ...
              <div className="flex flex-col gap-1 relative">
                <label className="font-sans text-[11px] font-black text-sm text-white uppercase tracking-widest">1. Name</label>
                <input
                  type="text"
                  name="name"
                  value={formData.name}
              ...
              {/* Field: Email */}
              <div className="flex flex-col gap-1 relative">
                <label className="font-sans text-[11px] font-black text-sm text-white uppercase tracking-widest">2. Enterprise Email</label>
                <input
                  type="email"
                  name="email"
              ...
              {/* Field: Phone Number */}
              <div className="flex flex-col gap-1 relative">
                <label className="font-sans text-[11px] font-black text-sm text-white uppercase tracking-widest">3. Secure Line</label>
                <input
                  type="text"
                  name="phone"
              ...
              {/* Field: Website */}
              <div className="flex flex-col gap-1 relative">
                <label className="font-sans text-[11px] font-black text-sm text-white uppercase tracking-widest">4. System Endpoints (URL)</label>
                <input
                  type="text"
                  name="website"
        ...
        <div className="flex items-center justify-between border-t border-zinc-800 pt-4 mt-12 font-mono text-[10px] text-zinc-500 tracking-wider">
          <span>INTEGRITY SHIELD: STABLE</span>
          <span>MAK DEVELOPERS CORE CLOUD</span>
        </div>
      </div>
    </section>
  );
